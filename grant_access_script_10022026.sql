DECLARE
    v_owners SYS.ODCIVARCHAR2LIST := SYS.ODCIVARCHAR2LIST('CMS_AUDIT','CMS_CARD_MGMT','CMS_GLOBAL','CMS_NOTIFICATION','GO_CONNECT','CMS_USER_ADMIN','CMS_SUPPORT','CMS_CARD','CMS_PROGRAM_CFG');  -- Source schemas
